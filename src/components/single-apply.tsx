...
const PhoneNumbersArrayErrors = (errors) =>
  typeof errors.phoneNumbers === 'string' ? <div>{errors.phoneNumbers}</div> : null;
    ...
    >
      {({ values, errors, touched }) => (
        <Form className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <TextInputComponent label="First name" name="data.firstName" autoComplete='given-name' />
          <TextInputComponent label="Last name" name="data.lastName" autoComplete='family-name' />
          ...
          <div className="col-span-full">
            ...
            {touched['data.phoneNumbers'] && errors['data.phoneNumbers'] && (
              <div className="label">
                <span className="label-text-alt text-error">{errors['data.phoneNumbers']}</span>
              </div>
            )}
          </div>
